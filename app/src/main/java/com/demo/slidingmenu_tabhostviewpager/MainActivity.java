...
public class MainActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listNavItems.add(new NavItem("Anasayfa", "Tüm Hizmetlerimiz",
				R.drawable.home));
		listNavItems.add(new NavItem("Sosyal Hesaplarımız", "Bizimle İlgili Bilgiler",
				R.drawable.sosyal));
		listNavItems.add(new NavItem("İletişim", "İletişim Bilgileri",
				R.drawable.iletisim));
